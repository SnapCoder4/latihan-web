...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2024 at 07:47 PM
...
('', '2024-12-09', 'P202409002', 379000, 1);
...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2024 at 07:11 PM
-- Server version: 10.4.32-MariaDB
-- PHP Version: 8.2.12
...
(2, 'valwagiraldy@gmail.com', '*20D64EF5D6A50662958D7FC708502F42DC142D50', 'valwa', 'yanto', '08321321', 'twitter_logo.png', '2024-12-09 06:27:37'),
(3, 'yanto@gmail.com', 'proplayer1st', 'valwa', 'jonggol', '08321321', 'twitter_logo.png', '2024-12-09 06:36:11'),
(4, 'luis@gmail.com', 'proplayer', 'luis', 'ganjar', '08321321', 'tes.png', '2024-12-09 06:49:51'),
(5, 'fanta@gmail.com', '$2y$10$5cxoXbAgAjSOfGuO0ymcaOdCTk69reD9i1VPALZ.KLd7iydM1ZXx.', 'fanta', 'fata', '0821312', '', '2024-12-09 07:24:31');
...
--
ALTER TABLE `riwayat_belanja`
  ADD CONSTRAINT `riwayat_belanja_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `namaproduct` (`idproduct`);
COMMIT;
