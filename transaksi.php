...
<head>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const toggleButton = document.getElementById('modeToggle'); // Tombol untuk mengganti mode
            const body = document.body;

            // Cek preferensi mode dari localStorage saat halaman dimuat
            if (localStorage.getItem('theme') === 'dark') {
                body.classList.add('dark-mode'); // Aktifkan dark mode jika disimpan di localStorage
            }

            // Event listener untuk tombol toggle
            toggleButton.addEventListener('click', function() {
                body.classList.toggle('dark-mode'); // Ubah antara mode gelap dan terang
